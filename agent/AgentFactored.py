...
class AgentFactored:
    ...
    def __init__(self, budgetTot, deadline, nCampaigns, nBudget, nBids, maxBudget=100.0, maxBid=2.0):
        ...
        # Historical sourceData: GP prediction
        self.gpsClicks = []
        self.gpsCosts = []

        # Historical sourceData: realizations
    ...
    def updateClickGP(self, c):
        """
        Updates the number of click GP with incoming sourceData
        :param c:
        :return:
        """
        # Format sourceData for the GP (2D vector)
        ...
        potentialClicks = divideFloat(self.prevClicks * 24.0, self.prevHours)
    ...
    def updateCostGP(self, c):
        ...
        potentialCosts = divideFloat(self.prevCosts * 24.0, self.prevHours)
    ...
    def optimize(self, values):
        # Inded in the results where the sourceData are
        valIdx = 0
        itIdx = 1
        bIdx = 2
