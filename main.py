...
c=[]
c.append(Campaign(a1, nusers=1000.0 , probClick=0.5 ,convParams= convparams1))
...
nBids=10
nIntervals=10
agent = AgentPrior(budgetTot=1000, deadline= deadline, ncampaigns=ncampaigns, nIntervals=nIntervals, nBids=nBids,maxBudget=100.0)
agent.initGPs()
env = Environment(c)
...
plotter.plotGP_prior(0,fixedBid=True,bid=0.55555)
...
plotter.plotGP_prior(1,fixedBid=True,bid=0.55555)
plotter.plotGP(1,fixedBid=True,bid=0.55555)

plotter.plotGP_prior(1,fixedBid=True,bid=0.11111)
plotter.plotGP(1,fixedBid=True,bid=0.11111)

plotter.plotGP_prior(1,fixedBid=True,bid=1.0)
plotter.plotGP(1,fixedBid=True,bid=1.0)
